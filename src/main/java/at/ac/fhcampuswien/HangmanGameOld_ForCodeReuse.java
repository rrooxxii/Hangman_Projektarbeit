...
public class HangmanGameOld_ForCodeReuse {
...
//Constructor
    ...
    public HangmanGameOld_ForCodeReuse() {

    }

    public HangmanGameOld_ForCodeReuse(int playerCount, String difficulty) {
...
//Getter_Setter
    ...
    //Need for New Startgame to Correspond to Start Button.
    public void startGameWithArgs() {
